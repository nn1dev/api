...
export const Email = ({ unsubscribeUrl }: EmailProps) => (
  <Layout>
    <Text>
      Another meetup is coming to your town <strong>on 29th of January</strong>,
      and this one is going to be filled with knowledge for web developers and
...
const renderEmailNewsletter_2026_01_14 = async (props: EmailProps) => ({
  html: await render(<Email {...props} />),
  text: await render(<Email {...props} />, { plainText: true }),
});

export default Email;
export { renderEmailNewsletter_2026_01_14 };
