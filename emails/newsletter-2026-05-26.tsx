...
export const Email = ({ unsubscribeUrl }: EmailProps) => (
  <Layout>
    ...
    <Text>
      Before we head off for our summer break, we're hosting a meetup in two
      days on Thursday, 28th May. Good speakers, good people, and tonnes of
      geeky conversations await! Details and registration via the link below. We
...
const renderEmailNewsletter_2026_05_26 = async (props: EmailProps) => ({
  html: await render(<Email {...props} />),
  text: await render(<Email {...props} />, { plainText: true }),
});

export default Email;
export { renderEmailNewsletter_2026_05_26 };
